...
type subCertDistPointsMissing struct{}
...
func (l *subCertDistPointsMissing) Initialize() error {
	return nil
}

func (l *subCertDistPointsMissing) CheckApplies(c *x509.Certificate) bool {
	return util.IsSubscriberCert(c)
}

func (l *subCertDistPointsMissing) Execute(c *x509.Certificate) *LintResult {
...
func init() {
	RegisterLint(&Lint{
		Name:          "e_sub_cert_crl_destribution_points_missing",
