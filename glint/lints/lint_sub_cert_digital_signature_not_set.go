...
type subCertDigSigNotSet struct{}
...
func (l *subCertDigSigNotSet) Initialize() error {
	return nil
}

func (l *subCertDigSigNotSet) CheckApplies(c *x509.Certificate) bool {
	return util.IsSubscriberCert(c) && util.IsExtInCert(c, util.KeyUsageOID)
}

func (l *subCertDigSigNotSet) Execute(c *x509.Certificate) *LintResult {
...
func init() {
	RegisterLint(&Lint{
		...
		Description:   "Subscriber Certificate: keyUsage The bit position for digitalSignature MUST be set.",
