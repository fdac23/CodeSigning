...
func (l *subCertKeyUsageNotCrit) Initialize() error {
	return nil
}
...
func (l *subCertKeyUsageNotCrit) Execute(c *x509.Certificate) *LintResult {
...
func init() {
	RegisterLint(&Lint{
		Name:          "e_sub_cert_key_not_critical",
