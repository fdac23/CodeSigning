...
type evCityOrTownMissing struct{}

func (l *evCityOrTownMissing) Initialize() error {
	return nil
}

func (l *evCityOrTownMissing) CheckApplies(c *x509.Certificate) bool {
	return util.IsEV(c.PolicyIdentifiers) && util.IsSubscriberCert(c)
}

func (l *evCityOrTownMissing) Execute(c *x509.Certificate) *LintResult {
...
func init() {
	RegisterLint(&Lint{
		Name:          "e_ev_city_or_town_missing",
