...
Subject’s locality information as verified under BR Section 3.2. If the
 subject:countryName field specifies the ISO 3166-1 user-assigned code
 of XX in accordance with BR Section 7.1.4.2.2.g., the localityName
...
func init() {
	RegisterLint(&Lint{
		Name:          "e_subscriber_certificate_locality_name_must_appear",
